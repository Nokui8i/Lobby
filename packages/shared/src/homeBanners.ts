...
/** רוחב תצוגה בעמוד מודעה — גובה הבאנר נגזר ממנו */
export const LISTING_BANNER_REFERENCE_WIDTH_PX = 800;
export const LISTING_BANNER_REFERENCE_HEIGHT_PX = Math.round(
  LISTING_BANNER_REFERENCE_WIDTH_PX / LISTING_BANNER_ASPECT,
);
