...
פלטפורמת השכרת דירות בישראל — ללא דמי תיווך לשוכרים. הכנסה מפרסום וחידוש מודעות בלבד.
...
**חובה לפני השקה:** תשתית כתובות (חיפוש כמו Yad2), סינון מלא, תשלום (פרסום/חידוש), אדמין.
